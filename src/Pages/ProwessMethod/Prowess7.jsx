...
// export default function Prowess7() {
...
//         setBanners(sorted);
//       })
//       .catch((err) => console.error("Prowess7 banner API error:", err))
//       .finally(() => setLoading(false));
//   }, []);
...
// // video thumbnail add akrne ke phele wala code
// import { useRef, useState, useEffect, useCallback } from "react";
// import "./Prowess7.css";
...
export default function Prowess7() {
  ...
  // const videoThumbnail =
  //   videoPlatform === "youtube" ? getYoutubeThumbnail(current.video_link) : null;
  // ✅ NAYA — API se img_tumbnail use karo (full URL banao)
        ...
        <div className="about1-prow-right">
          <div className={videoCardClass}>
            ...
            >
              ...
              {/* // ✅ NAYA — kisi bhi platform pe agar thumbnail hai to dikhao */}
              {videoThumbnail ? (
                <img
                  src={videoThumbnail}
                  alt="Video Thumbnail"
